const buildNav = (basePath, isSearch) => {
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="${basePath}index.html">
                <img src="${basePath}img/logo-small.png" alt="Anzom" />
            </a>
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a id="homeLnk" class="nav-link" href="${basePath}index.html">
                    ...
                    <li class="nav-item">
                        <a id="loginLnk" class="nav-link" href="${basePath}pages/account.html">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="#" onclick="displayFeaturedProducts();">
                            ...
                            <li id="catMenu">
                                <!-- Sub-menu populated on page load (common.js/category.js) -->
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="${basePath}pages/cart.html">
                ...
                ${isSearch ? "" :
                    `<form class="d-flex" action="${basePath}pages/search.html" method="get">
                    <input class="form-control me-2" type="search" name="q" placeholder="Search here..."
...
const buildFooter = () => {
    ...
    <nav class="navbar fixed-bottom navbar-light bg-light">
        <div class="container-fluid">
            All rights reserved &copy; 2024 Anzom
            <div class="d-flex"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="24"

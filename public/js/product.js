    ...
    const detailContent = `
        <div class="row justify-content-md-center p-2">
                        ...
                        ${imageUrls.map(iurl => {
                            ...
                            return `
                                <div class="carousel-item ${active}">
                                    <img src="${iurl}" class="w-100" alt="${product.name}"/>
                                </div>
                            `;
                        })};
                    </div>
            ...
            <div class="col-6">
                ...
                <p><span class="badge text-bg-danger">LOW STOCK</span></p>
                <p>
        ...
        <div class="row justify-content-center p-2">
            <div class="col-10">
                ${products.map(product => {
                    ...
                    return (`
                    <div class="row">
                        <div class="col-3"><img src="${noImageUrl(imageUrls[0])}" class="card-img-top" alt="${product.name}"/></div>

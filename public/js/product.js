        ...
        const featuredProductHTML = products.map(product => `
            <section class="cardslot p-3" onclick="buildProductDetail('${product.cid}', '${product.scid}', '${product.id}')">
                <div class="product">
                    ...
                    <div id="spin${product.id}" class="spinner-grow d-none" role="status">
...
const displayDetailPage = async (pid) => {
    ...
    const addToCartEnabled = product.stock_quantity > 0 && loginToken() && !getProfile().seller;
    ...
    const detailContent = `
        <div class="row justify-content-md-center p-2">
            ...
            <div class="col-md-12 col-lg-6">
                <p class="fs-2">
                    ${product.name}
                    ${product.featured ? "<span class='badge fs-6 text-bg-info'>FEATURED</span>" : ""}
                </p>
                ...
                <p>
                    <button type="button" class="btn btn-dark" ${addToCartEnabled ? "" : "disabled"}>
    ...
    products.forEach(product => {
        ...
        plpLines += `<div class="row p-2">
            ...
            <div class="col-sm-6 col-md-2 col-xl-2">
                <span id="eye${product.id}" style="cursor: pointer" onclick="displayDetailPage('${product.id}')">
